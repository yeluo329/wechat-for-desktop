...
import ui.common.theme.color.light.DarkColorPalette
import ui.common.theme.color.light.DefaultColorPalette
...
var AppColorsProvider = compositionLocalOf { DefaultColorPalette }
...
@Composable
fun AppTheme(themeType: Int, isDark: Boolean = isInDarkTheme(), content: @Composable () -> Unit) {
    val targetColors = DarkColorPalette
